...
import CommentsEditView from '../comments-edit/view.js';
import CommentsRepliesView from '../comments-replies/view.js';
import CommentVote from '../comment-vote/view.js';
...
export default class CommentCard extends View {
  ...
  onsuccessedit (data) {
    ...
    var tendency = this.find('span.tendency');
    tendency
      .removeClass('against')
      .removeClass('neutral')
      .removeClass('infavor')
      .addClass(data.tendency)
      .html(t('comments.' + data.tendency));
  }
